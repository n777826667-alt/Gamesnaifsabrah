...
export default function FoodWheelPage() {
  ...
  const getPatternPredictions = (sequence: string[]): PredictionResult => {
    ...
    const patterns: { [key: string]: string[] } = {
      ...
      "ذرة→سمكة": ["بيبار", "جزر", "جمبري", "طماط"],
      "طماط→بقره": ["طماط", "ذرة", "جزر", "كتكوت", "جمبري"],
      "بيبار→جمبري": ["بيبار", "جمبري", "بقره", "سمكة", "جزر"],
      "جزر→كتكوت": ["ذرة", "جزر", "جمبري", "بقره"],

      "جمبري→بقره": ["طماط", "ذرة", "جزر"],
